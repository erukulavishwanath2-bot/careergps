/* ==========================================================================
   Career GPS - Standalone SPA Engine (All 10 Phases & AI Features)
   ========================================================================== */
...
const DEFAULT_PROFILE = {
  ...
  badges: [
    { id: 'b1', name: 'Explorer', description: 'Started your Career GPS journey', icon: '🚀' },
    { id: 'b2', name: 'Logic Champion', description: 'Scored 85%+ on Aptitude Assessment', icon: '🧠' }
  ],
...
const CAREERS_DATA = [
  {
    ...
    description: 'AI Engineers design and deploy complex machine learning algorithms, deep neural networks, and generative AI systems that power future automation.',
    futureDemand: 'Extremely High',
    futureDemandScore: 98,
    salaryRange: { entry: '$85,000 - $120,000', mid: '$140,000 - $190,000', senior: '$220,000 - $380,000+' },
    coreSkills: ['Python & PyTorch', 'Deep Learning & LLMs', 'Linear Algebra', 'MLOps & Docker'],
    dayInTheLife: 'You analyze multi-terabyte datasets, fine-tune transformer models, collaborate with product teams, and benchmark neural network latency.',
    roadmapNodes: [
      { id: 'ai-step-1', stage: 'Class 10 - 12', title: 'Master Advanced Math & Programming', description: 'Focus on Calculus, Linear Algebra, Statistics, and basic Python programming.', estimatedDuration: '2 Years' },
      { id: 'ai-step-2', stage: 'College Degree', title: 'B.S. in CS / AI & Data Science', description: 'Undergraduate study emphasizing Data Structures, Neural Networks, and Algorithms.', estimatedDuration: '4 Years' },
      { id: 'ai-step-3', stage: 'Projects & Internships', title: 'Build Open Source AI & Kaggle Competitions', description: 'Compete in Kaggle competitions and contribute to open-source models.', estimatedDuration: '1-2 Years' },
      { id: 'ai-step-4', stage: 'First Job', title: 'Junior AI Engineer / Research Scientist', description: 'Ship fine-tuned AI models into production applications.', estimatedDuration: 'Ongoing' }
    ]
  },
  {
    id: 'cyber-security',
    ...
    description: 'Cyber Security Specialists protect networks, servers, and applications from cyber-attacks and conduct ethical hacking penetration testing.',
    futureDemand: 'Extremely High',
    futureDemandScore: 95,
    salaryRange: { entry: '$75,000 - $105,000', mid: '$120,000 - $160,000', senior: '$180,000 - $280,000+' },
    coreSkills: ['Penetration Testing', 'Network Protocol Analysis', 'Ethical Hacking', 'SIEM & Cloud Security'],
    dayInTheLife: 'You perform vulnerability scans, simulate attack vectors, monitor threat intelligence feeds, and respond to security incidents.',
    roadmapNodes: [
      { id: 'cs-step-1', stage: 'Class 10 - 12', title: 'Learn Networking & Linux Basics', description: 'Understand TCP/IP, OSI Model, Command Line Linux, and Python scripting.', estimatedDuration: '1 Year' },
      { id: 'cs-step-2', stage: 'College & Certs', title: 'B.S. in Cyber Security + CompTIA Security+', description: 'Pursue CS degree along with recognized security credentials.', estimatedDuration: '4 Years' }
    ]
  },
  {
    id: 'fullstack-dev',
    ...
    description: 'Full Stack Engineers work across frontend UI, backend server logic, databases, and DevOps pipelines to build high-performance digital products.',
    futureDemand: 'High',
    futureDemandScore: 92,
    salaryRange: { entry: '$70,000 - $100,000', mid: '$125,000 - $170,000', senior: '$190,000 - $300,000+' },
    coreSkills: ['TypeScript / React', 'Node.js & Express', 'PostgreSQL / MongoDB', 'System Design'],
    dayInTheLife: 'You build user interfaces in React, write REST APIs, optimize SQL queries, and deploy cloud microservices.',
    roadmapNodes: [
      { id: 'fs-step-1', stage: 'Class 11 - 12', title: 'Frontend Basics (HTML, CSS, JS)', description: 'Master responsive layouts, DOM manipulation, git version control.', estimatedDuration: '6 Months' },
      { id: 'fs-step-2', stage: 'College', title: 'React, Node.js & Database Systems', description: 'Learn single-page applications, backend routing, and databases.', estimatedDuration: '3 Years' }
    ]
  },
  {
    id: 'ux-ui-designer',
    ...
    description: 'Product Designers craft visual layouts, interactive user journeys, and design systems for web and mobile apps.',
    futureDemand: 'High',
    futureDemandScore: 89,
    salaryRange: { entry: '$65,000 - $90,000', mid: '$110,000 - $150,000', senior: '$165,000 - $250,000+' },
    coreSkills: ['Figma Wireframing', 'User Research', 'Design Systems', 'Prototyping'],
    dayInTheLife: 'You conduct user interviews, wireframe in Figma, test interactive prototypes, and collaborate with developers.',
    roadmapNodes: [
      { id: 'ux-step-1', stage: 'Exploration', title: 'Master Figma & Visual Principles', description: 'Learn color theory, layout grids, typography, and visual hierarchy.', estimatedDuration: '6 Months' }
    ]
  }
];

const LEARNING_COURSES = [
  { id: 'c1', title: 'Python for AI & Data Science', category: 'Coding', duration: '4 Hours', xpReward: 150, description: 'Master core Python, NumPy, Pandas, and basic Machine Learning algorithms.', quiz: [ { question: 'Which Python structure is immutable and ordered?', options: ['Tuple', 'List', 'Dictionary'], correct: 0, exp: 'Tuples cannot be modified after creation.' } ] },
  { id: 'c2', title: 'Generative AI & Prompt Engineering', category: 'AI Tools', duration: '2 Hours', xpReward: 100, description: 'Learn zero-shot, few-shot, and chain-of-thought prompt engineering.', quiz: [ { question: 'What is Chain-of-Thought prompting?', options: ['Breaking reasoning step-by-step before answering', 'Connecting multiple API keys'], correct: 0, exp: 'Chain-of-thought reduces logical errors.' } ] },
  { id: 'c3', title: 'STAR Interview Framework Mastery', category: 'Interview Skills', duration: '3 Hours', xpReward: 140, description: 'Structure high-impact answers for behavioral and technical interviews.', quiz: [ { question: 'What does STAR stand for?', options: ['Situation, Task, Action, Result', 'Summary, Topic, Answer, Reaction'], correct: 0, exp: 'STAR ensures structured answers.' } ] }
];

const OPPORTUNITIES_DATA = [
  { id: 'opp-1', title: 'Global Future Tech Innovators Scholarship 2026', type: 'Scholarship', org: 'Global STEM Foundation', reward: '$10,000 Tuition Grant', deadline: 'Aug 30, 2026', desc: 'Fully funded grant awarded to high-achieving students in AI, Cyber Security, or Bioengineering.' },
  { id: 'opp-2', title: 'Summer AI & Full Stack Developer Internship', type: 'Internship', org: 'Antigravity Labs', reward: '$3,500 / month', deadline: 'Aug 15, 2026', desc: 'Work alongside software engineers to build generative AI tools and web apps.' },
  { id: 'opp-3', title: 'HackTheFuture Global Student Hackathon', type: 'Hackathon', org: 'MLH', reward: '$25,000 Cash Pool', deadline: 'Sep 10, 2026', desc: '48-hour global sprint to build solutions in climate tech or healthcare.' }
];

// App State
let profile = JSON.parse(localStorage.getItem('career_gps_profile') || JSON.stringify(DEFAULT_PROFILE));
let activeTab = 'dashboard';
let isAIChatOpen = false;
let chatMessages = [
  { sender: 'ai', text: `Hello ${profile.name}! 👋 I am your AI Career Counselor. How can I guide your career roadmap today?` }
];

function saveState() {
  localStorage.setItem('career_gps_profile', JSON.stringify(profile));
}
...
export function renderApp() {
  ...
  app.innerHTML = `
      ...
      <div style="max-width: 1440px; margin: 0 auto; padding: 12px 24px; display: flex; align-items: center; justify-content: space-between; gap: 16px;">
        ...
        <nav style="display: flex; gap: 4px; background: rgba(255,255,255,0.03); padding: 4px; border-radius: 14px; border: 1px solid var(--border-glass); overflow-x: auto;">
          ${[
            ...
            { id: 'exploration', label: 'Careers Library', icon: '🔍' },
            { id: 'recommendations', label: 'AI Matches', icon: '✨' },
            { id: 'roadmap', label: 'Roadmap', icon: '🛣️' },
            { id: 'learning', label: 'Learning Hub', icon: '📚' },
            { id: 'resume-builder', label: 'Resume Builder', icon: '📄' },
            { id: 'interview-coach', label: 'AI Interview', icon: '🎙️' },
            { id: 'opportunities', label: 'Opportunities', icon: '🌐' }
          ].map(tab => `
            <button class="nav-tab-btn" data-tab="${tab.id}" style="display: flex; align-items: center; gap: 6px; padding: 8px 14px; border-radius: 10px; border: none; background: ${activeTab === tab.id ? 'var(--grad-primary)' : 'transparent'}; color: ${activeTab === tab.id ? '#fff' : 'var(--text-muted)'}; font-weight: ${activeTab === tab.id ? 700 : 500}; cursor: pointer; white-space: nowrap;">
    ...
    ${isAIChatOpen ? renderAIChatDrawer() : ''}
  `;
...
function renderActiveView() {
  switch (activeTab) {
    ...
    case 'self-discovery': return renderSelfDiscovery();
    case 'exploration': return renderExploration();
    case 'recommendations': return renderRecommendations();
    case 'roadmap': return renderRoadmap();
    case 'learning': return renderLearningHub();
    case 'resume-builder': return renderResumeBuilder();
    case 'interview-coach': return renderInterviewCoach();
...
function renderDashboard() {
  const targetCareer = CAREERS_DATA.find(c => c.id === profile.targetCareerId) || CAREERS_DATA[0];
  const progressPercent = Math.round((profile.unlockedRoadmapSteps.length / targetCareer.roadmapNodes.length) * 100);
    ...
    <div style="display: flex; flex-direction: column; gap: 24px;">
      <div class="glass-panel" style="padding: 32px; background: linear-gradient(135deg, rgba(99,102,241,0.15) 0%, rgba(6,182,212,0.12) 100%); border: 1px solid rgba(99,102,241,0.25); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 20px;">
        <div>
          <div style="display: flex; gap: 8px; margin-bottom: 8px;">
            ...
            <span class="badge badge-emerald">⚡ ${profile.streakDays} Day Learning Streak</span>
          </div>
          <h1 style="font-size: 2.2rem; font-weight: 800; margin-bottom: 8px;">Welcome back, <span class="gradient-text">${profile.name}</span>! 🎯</h1>
          <p style="color: var(--text-muted); font-size: 1rem; max-width: 600px;">
            You are building towards becoming a <strong>${targetCareer.title}</strong>. Current profile compatibility match is <strong>96%</strong>.
          </p>
        ...
        <div style="background: rgba(15,23,42,0.7); border: 1px solid var(--border-glass); padding: 24px 28px; border-radius: 20px; text-align: center;">
          ...
          <div style="font-size: 3rem; font-weight: 800; color: #818cf8; font-family: var(--font-heading);">Lvl ${profile.level}</div>
          <div style="font-size: 0.88rem; color: #38bdf8; font-weight: 700;">${profile.xp} XP Earned</div>
        </div>
      </div>
      ...
      <div class="grid-4">
        <div class="glass-panel" style="padding: 20px;">
          ...
          <div style="font-size: 1.2rem; font-weight: 800; color: #fff; margin-top: 4px;">${targetCareer.title}</div>
          <div style="font-size: 0.8rem; color: #34d399; margin-top: 4px;">Salary: ${targetCareer.salaryRange.mid}</div>
        </div>
        <div class="glass-panel" style="padding: 20px;">
          <div style="font-size: 0.82rem; color: var(--text-muted);">Roadmap Progress</div>
          <div style="font-size: 1.8rem; font-weight: 800; color: #fff; margin-top: 4px;">${progressPercent}%</div>
          <div style="font-size: 0.8rem; color: var(--text-muted);">${profile.unlockedRoadmapSteps.length} of ${targetCareer.roadmapNodes.length} milestones done</div>
        </div>
        <div class="glass-panel" style="padding: 20px;">
        ...
        <div class="glass-panel" style="padding: 20px;">
          ...
          <div style="font-size: 1.8rem; font-weight: 800; color: #fff; margin-top: 4px;">${profile.badges.length} Badges</div>
...
// 2. Self-Discovery View
function renderSelfDiscovery() {
  return `
    <div class="glass-panel" style="padding: 32px;">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 24px;">
        <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-glass); padding: 20px; border-radius: 16px;">
          ...
          <div style="font-size: 1.3rem; font-weight: 800; color: #fff; margin-top: 4px;">${profile.personalityType}</div>
        </div>
        <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-glass); padding: 20px; border-radius: 16px;">
          <div style="font-size: 0.8rem; color: #34d399; font-weight: 700;">STRENGTHS</div>
          <div style="display: flex; flex-wrap: wrap; gap: 4px; margin-top: 6px;">
            ${profile.strengths.map(s => `<span class="badge badge-emerald">${s}</span>`).join('')}
          </div>
        </div>
        <div style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-glass); padding: 20px; border-radius: 16px;">
          <div style="font-size: 0.8rem; color: #fbbf24; font-weight: 700;">APTITUDE SCORE</div>
          <div style="font-size: 1.6rem; font-weight: 800; color: #fbbf24; margin-top: 4px;">${profile.aptitudeScore} / 100</div>
        </div>
      </div>
          ...
          <div class="glass-panel glass-card-interactive" style="padding: 24px; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                ...
                <span style="font-size: 0.78rem; color: #34d399; font-weight: 700;">Demand: ${c.futureDemandScore}%</span>
              </div>
              <h3 style="font-size: 1.2rem; font-weight: 800; color: #fff; margin-bottom: 6px;">${c.title}</h3>
              <p style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 14px;">${c.tagline}</p>
              <div style="font-size: 0.82rem; color: #fbbf24; font-weight: 700; margin-bottom: 12px;">Mid Salary: ${c.salaryRange.mid}</div>
            </div>
            <button class="btn-primary" style="width: 100%; justify-content: center; font-size: 0.84rem;" onclick="window.setTargetCareer('${c.id}')">Set as My Career Target</button>
          </div>
        `).join('')}
      </div>
    </div>
          ...
          <div class="glass-panel" style="padding: 24px; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
                <span style="background: var(--grad-primary); color: #fff; font-weight: 800; padding: 4px 12px; border-radius: 20px; font-size: 0.9rem;">${98 - i * 5}% Match</span>
                <span class="badge badge-emerald">Rank #${i + 1}</span>
              </div>
              <h3 style="font-size: 1.25rem; font-weight: 800; color: #fff; margin-bottom: 4px;">${c.title}</h3>
              <p style="font-size: 0.84rem; color: var(--text-muted); margin-bottom: 14px;">${c.tagline}</p>
            </div>
            <button class="btn-primary" style="width: 100%; justify-content: center;" onclick="window.setTargetCareer('${c.id}')">Generate Step Roadmap →</button>
          </div>
        `).join('')}
      </div>
    </div>
...
function renderRoadmap() {
  const career = CAREERS_DATA.find(c => c.id === profile.targetCareerId) || CAREERS_DATA[0];
  ...
  return `
    <div style="display: flex; flex-direction: column; gap: 24px;">
      <div class="glass-panel" style="padding: 28px 32px; background: linear-gradient(135deg, rgba(99,102,241,0.18) 0%, rgba(6,182,212,0.12) 100%);">
        ...
        <h1 style="font-size: 1.8rem; font-weight: 800;">Roadmap for <span class="gradient-text">${career.title}</span></h1>
        <p style="color: var(--text-muted); font-size: 0.95rem;">Mark milestones as complete to earn +50 XP each!</p>
      </div>

      <div style="display: flex; flex-direction: column; gap: 20px;">
        ${career.roadmapNodes.map((node, i) => {
          const isDone = profile.unlockedRoadmapSteps.includes(node.id);
          return `
            <div class="glass-panel" style="padding: 24px; border: ${isDone ? '1px solid rgba(16,185,129,0.4)' : '1px solid var(--border-glass)'}; background: ${isDone ? 'rgba(16,185,129,0.04)' : 'var(--bg-card)'};">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                  <span class="badge badge-cyan">${node.stage} • ${node.estimatedDuration}</span>
                  <h3 style="font-size: 1.3rem; font-weight: 800; color: #fff; margin-top: 6px;">Step ${i + 1}: ${node.title}</h3>
                  <p style="font-size: 0.88rem; color: var(--text-muted); margin-top: 4px;">${node.description}</p>
                </div>
                <button class="${isDone ? 'btn-secondary' : 'btn-primary'}" onclick="window.toggleStep('${node.id}')">
                  ${isDone ? '✓ Done (+50 XP)' : 'Mark Complete'}
                </button>
              </div>
            </div>
          `;
          ...
          <div class="glass-panel" style="padding: 24px; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                ...
                <span class="badge badge-amber">+${course.xpReward} XP</span>
              </div>
              <h3 style="font-size: 1.2rem; font-weight: 800; color: #fff; margin-bottom: 6px;">${course.title}</h3>
              <p style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 14px;">${course.description}</p>
            </div>
            <button class="btn-primary" style="width: 100%; justify-content: center;" onclick="window.takeQuiz('${course.id}')">Start Skill Quiz →</button>
          </div>
        `).join('')}
      </div>
    </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 24px;">
      ...
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
        <div class="glass-panel" style="padding: 24px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 12px;">
            <div>
              ...
              <input type="text" value="${profile.name}" style="width: 100%; background: rgba(255,255,255,0.05); border: 1px solid var(--border-glass); border-radius: 8px; padding: 8px 12px; color: #fff;" />
            </div>
            <div>
        ...
        <div className="glass-panel" style="padding: 28px; background: #ffffff; color: #0f172a; border-radius: 16px;">
          <h2 style="font-size: 1.6rem; font-weight: 800; color: #0f172a; border-bottom: 2px solid #0f172a; padding-bottom: 8px; margin-bottom: 12px;">${profile.name}</h2>
    ...
    <div style="display: flex; flex-direction: column; gap: 24px;">
      ...
      <div class="grid-2">
        ${OPPORTUNITIES_DATA.map(opp => `
          <div class="glass-panel" style="padding: 24px; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              <span class="badge badge-cyan" style="margin-bottom: 8px;">${opp.type}</span>
              <h3 style="font-size: 1.25rem; font-weight: 800; color: #fff; margin-bottom: 4px;">${opp.title}</h3>
              <div style="font-size: 0.85rem; color: #818cf8; font-weight: 600; margin-bottom: 10px;">${opp.org}</div>
              <p style="font-size: 0.86rem; color: var(--text-muted); margin-bottom: 14px;">${opp.desc}</p>
              <div style="font-size: 0.84rem; color: #34d399; font-weight: 700;">Grant / Stipend: ${opp.reward}</div>
            </div>
            <button class="btn-primary" style="margin-top: 16px; justify-content: center;" onclick="alert('Application link opened for ${opp.title}')">Apply Now ↗</button>
          </div>
        `).join('')}
      </div>
    </div>
  ...
  return `
    <div style="position: fixed; bottom: 24px; right: 24px; width: 400px; height: 580px; max-width: calc(100vw - 32px); z-index: 1000; background: rgba(15,23,42,0.96); backdrop-filter: blur(24px); border: 1px solid var(--border-glass-glow); border-radius: 24px; box-shadow: 0 20px 50px rgba(0,0,0,0.6); display: flex; flex-direction: column; overflow: hidden;">
      ...
      <div style="flex: 1; padding: 16px; overflow-y: auto; display: flex; flex-direction: column; gap: 12px;">
        ${chatMessages.map(m => `
          <div style="align-self: ${m.sender === 'user' ? 'flex-end' : 'flex-start'}; background: ${m.sender === 'user' ? 'var(--grad-primary)' : 'rgba(30,41,59,0.9)'}; color: #fff; padding: 10px 14px; border-radius: 14px; max-width: 85%; font-size: 0.88rem;">
            ${m.text}
          </div>
        `).join('')}
      </div>
...
// Global Event Listeners & Actions
function attachEventListeners() {
  ...
  if (logo) logo.onclick = () => { activeTab = 'dashboard'; renderApp(); };

  const aiBtn = document.getElementById('toggle-ai-btn');
  if (aiBtn) aiBtn.onclick = () => { isAIChatOpen = !isAIChatOpen; renderApp(); };
}

window.switchTab = (tab) => { activeTab = tab; renderApp(); };
window.toggleAIChat = () => { isAIChatOpen = !isAIChatOpen; renderApp(); };

window.setTargetCareer = (id) => {
  profile.targetCareerId = id;
  saveState();
  activeTab = 'roadmap';
  renderApp();
};
...
window.toggleStep = (stepId) => {
  if (!profile.unlockedRoadmapSteps.includes(stepId)) {
    profile.unlockedRoadmapSteps.push(stepId);
    profile.xp += 50;
...
window.takeQuiz = (courseId) => {
  profile.xp += 150;
  profile.level = Math.floor(profile.xp / 200) + 1;
  profile.completedQuizzes.push(courseId);
  saveState();
  if (window.confetti) window.confetti({ particleCount: 90, spread: 70 });
  alert('🎉 Skill Quiz Passed! Earned +150 XP!');
  renderApp();
};

window.submitInterviewAns = () => {
  const ans = document.getElementById('interview-ans').value;
  if (!ans) return;
  profile.xp += 50;
  saveState();
  const fb = document.getElementById('interview-feedback-box');
...
window.sendChatMessage = (e) => {
  ...
  setTimeout(() => {
    chatMessages.push({
      sender: 'ai',
      text: `For your target career in ${profile.targetCareerId.toUpperCase()}, I recommend taking python/data courses and applying for top summer internships in the Opportunity Center!`
    });
    renderApp();
  }, 400);
